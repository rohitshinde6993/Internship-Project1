...
const Login = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Simulating login (store user data properly in real app)
  ...
  return (
    <div className="relative flex min-h-screen items-center justify-center bg-cover bg-center overflow-hidden" style={{ backgroundImage: "url('/background.jpg')" }}>
      ...
      <div className="relative w-full max-w-md p-8 rounded-2xl border border-white/40 bg-white/10 backdrop-blur-lg shadow-[0px_0px_30px_rgba(255,255,255,0.9)] 
        ...
        <h1 className="text-4xl font-extrabold text-center text-white mb-6 animate-slide-down">Welcome Back</h1>
        <p className="text-gray-200 text-center mb-6 animate-slide-up">Login to explore amazing recipes!</p>
        ...
        <p className="mt-6 text-center text-gray-200">
          ...
          <button onClick={() => router.push("/register")} className="text-blue-300 font-bold hover:underline transition-all duration-300 hover:scale-105">
            Register
          </button>
        </p>
      </div>
